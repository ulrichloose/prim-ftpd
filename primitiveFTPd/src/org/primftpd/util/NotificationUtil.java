...
public class NotificationUtil
{
	...
	private static Notification.Builder createStubNotification(
		...
		PendingIntent contentIntent = PendingIntent.getActivity(ctxt, 0, notificationIntent, PendingIntent.FLAG_IMMUTABLE);

		Intent stopIntent = StartStopWidgetProvider.buildServerStartStopIntent(ctxt);
		PendingIntent pendingStopIntent = PendingIntent.getBroadcast(ctxt, 0, stopIntent, PendingIntent.FLAG_IMMUTABLE);
