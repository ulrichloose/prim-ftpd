...
public abstract class AbstractFilePickerFragment<T> extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.filepicker_button_cancel)
        ...
        view.findViewById(R.id.filepicker_button_ok_newfile).setOnClickListener(
    ...
    protected void configureItemDecoration(@NonNull LayoutInflater inflater,
        ...
        final TypedArray attributes =
                getActivity().obtainStyledAttributes(new int[]{R.attr.filepickerListItemDivider});
    ...
    public void onClickOk(@NonNull View view) {
        ...
        if ((allowMultiple || mode == MODE_FILE) &&
            ...
            if (mToast == null) {
                mToast = Toast.makeText(getActivity(), R.string.filepickerSelectSomethingFirst,
                        Toast.LENGTH_SHORT);
            }
            mToast.show();
            return;
